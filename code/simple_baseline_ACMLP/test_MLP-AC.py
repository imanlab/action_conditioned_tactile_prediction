...
model_path      = "/home/user/Robotics/tactile_prediction/tactile_prediction/models/simple_baseline_ACMLP/saved_models/box_only_model_09_12_2021_15_03/ACTP_model"
data_save_path  = "/home/user/Robotics/tactile_prediction/tactile_prediction/models/simple_baseline_ACMLP/saved_models/box_only_model_09_12_2021_15_03/"
test_data_dir   = "/home/user/Robotics/Data_sets/box_only_dataset/train_linear_dataset_10c_10h/"
...
class ModelTester:
    ...
    def test_full_model(self):
        ...
        for index, batch_features in enumerate(self.test_full_loader):
            ...
            for i in [0, 1]:
                ...
                self.prediction_data.append([tactile_predictions_cut.cpu().detach(), tactile_cut[context_frames:].cpu().detach(), experiment_number_cut.cpu().detach(), time_steps_cut.cpu().detach()])
    ...
    def calc_trial_performance(self):
        ...
        self.performance_data.append([mae_loss / index, mae_loss_1 / index, mae_loss_5 / index, mae_loss_10 / index,
    ...
    def calc_train_performance(self):
        ...
        self.objects = list(set(self.objects))
        for object in self.objects:
            performance_data_full.append(["train loss MAE(L1) Trained object " + str(object) + ": ", (sum([i[0] for i in self.performance_data if i[-1] == str(object)]) / len([i[0] for i in self.performance_data if i[-1] == str(object)]))])
